...
struct Bessik {
	...
	double i0(const double x) const;	// Returns the modified Bessel function I0(x) for any real x

	double i1(const double x) const;	// Returns the modified Bessel function I1(x) for any real x

	double k0(const double x) const;	// Returns the modified Bessel function K0(x) for positive real x.


	double k1(const double x) const; // Returns the modified Bessel function K1(x) for positive real x.

	double in(const int n, const double x) const;
	// Returns the modified Bessel function In(x) for any real x and n >= 0;

	double kn(const int n, const double x) const;
